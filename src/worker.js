export default {
    async fetch(request, env) {
        ...
        // Redirect short link (ví dụ: /abc123)
        if (path && path !== 'favicon.ico' && path !== 'stats' && path !== 'links' && path !== 'shorten' && !path.startsWith('delete/')) {
            try {
        ...
        // Trang chủ - fetch từ GitHub Pages
        return fetch('https://enactusftuhanoi.github.io/s/', {
            headers: {
                'Host': 'enactusftuhanoi.github.io'
            }
        });
    }
};
